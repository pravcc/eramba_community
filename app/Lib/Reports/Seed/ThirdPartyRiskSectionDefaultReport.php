 ...
 * Report Seed.
 */
class ThirdPartyRiskSectionDefaultReport extends ReportSeed
{
	/**
	...
	{
		$this
			->setSlug('third-party-risk-section-default-report')
			->setReport([
			...
			->addTextBlock(
				ReportBlock::SIZE_12,
				__('<h1><b>Third Party Risk Summary</b></h1><p>This report describes general attributes for all Third Party Risks in the scope of this GRC program.</p>')
			)
			->addChartBlock(
				ReportBlock::SIZE_6,
				'ThirdPartyRisk',
