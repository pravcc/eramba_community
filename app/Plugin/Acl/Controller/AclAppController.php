...
class AclAppController extends AppController
{
    ...
    function beforeFilter()
	{
		...
		$this->set( 'subtitle_for_layout', __( 'You can define the level of access for each group in the system. Be patient and wait for the full page to load before making any modification. Modifications on a specific permission are saved but not enforced automatically. Users will need to log-off to get the updated permissions.' ) );
