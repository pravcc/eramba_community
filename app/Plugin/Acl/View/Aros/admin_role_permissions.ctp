        ...
        <div class="panel panel-flat">
            <div class="panel-body">
                		    	...
                		    	foreach($roles as $role)
                		    	{
                		    	    ...
                		    	    if(isset($ctrl_info['permissions'][$role[$role_model_name][$role_pk_name]]))
                		    	    {
                    		    		if($ctrl_info['permissions'][$role[$role_model_name][$role_pk_name]] == 1)
                    		    		{
                        					...
                        					echo $this->Html->tag('i', ' ', array('class' => 'icon-checkmark5 icon-green icon-2x pointer'));
                    		    		}
                    		    		else
                    		    		{
                        					...
                        					echo $this->Html->tag('i', ' ', array('class' => 'icon-cross icon-red icon-2x pointer'));
                    		    		}
                		    	    }
                		    	    else
                		    	    {
                        				...
                        				echo $this->Html->tag('i', ' ', array('class' => 'icon-exclamation icon-orange icon-2x', 'title' => __d('acl', 'The ACO node is probably missing. Please try to rebuild the ACOs first.')));
                		    	    }
                ...
                //    	    debug($plugin_ctrler_infos);
                	...
                	echo $this->Html->tag('i', ' ', array('class' => 'icon-checkmark5 icon-green icon-2x')) . ' ' . __d('acl', 'authorized');
                    echo '&nbsp;&nbsp;&nbsp;';
                    //echo $this->Html->image('/acl/img/design/cross.png') . ' ' . __d('acl', 'blocked');
                    echo $this->Html->tag('i', ' ', array('class' => 'icon-cross icon-red icon-2x')) . ' ' . __d('acl', 'blocked');
                    ?>
