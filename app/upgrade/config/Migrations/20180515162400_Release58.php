...
class Release58 extends AbstractMigration
{
    protected function bumpVersion($value) {
        ...
        if (class_exists('App')) {
            ...
            if (Configure::read('Eramba.version') === 'e1.0.6.057') {
                // what triggers on actual update process
                ...
                $ret &= $AssociativeDeleteShell->delete_remaining_items();
            }
        ...
        if (!$ret) {
            ...
            $log = "Error occured when processing database synchronization for release 1.0.6.058.";
    ...
    public function up()
    {
        $this->bumpVersion('e1.0.1.038');
    }

    public function down()
    {
        $this->bumpVersion('e1.0.1.037');
    }
}
