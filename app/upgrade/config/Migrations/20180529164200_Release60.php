...
class Release60 extends AbstractMigration
{
    protected function bumpVersion($value) {
        ...
        if (class_exists('App')) {
            ...
            if (Configure::read('Eramba.version') === 'e1.0.6.059') {
        ...
        if (!$ret) {
            ...
            $log = "Error occured when processing database synchronization for release 1.0.6.060.";
