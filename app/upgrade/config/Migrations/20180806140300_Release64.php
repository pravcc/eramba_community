...
class Release64 extends AbstractMigration
{
    protected function bumpVersion($value) {
        ...
        if (class_exists('App')) {
            ...
            if (Configure::read('Eramba.version') === 'e1.0.6.063') {
                // resave wrong values for compliance audits_last_passed status
        ...
        if (!$ret) {
            ...
            $log = "Error occured when processing database synchronization for release 1.0.6.064.";
    ...
    public function up()
    {
        $this->bumpVersion('e1.0.1.044');
    }

    public function down()
    {
        $this->bumpVersion('e1.0.1.043');
    }
}
