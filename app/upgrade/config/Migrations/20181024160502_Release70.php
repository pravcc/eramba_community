...
class Release70 extends AbstractMigration
{
    protected function bumpVersion($value) {
        ...
        if (class_exists('App')) {
            ...
            if (Configure::read('Eramba.version') === 'e1.0.6.069') {
        ...
        if (!$ret) {
            ...
            $log = "Error occured when processing database synchronization for release 1.0.6.070.";
    ...
    public function up()
    {
        $this->bumpVersion('e1.0.1.050');
    }

    public function down()
    {
        $this->bumpVersion('e1.0.1.049');
    }
}
