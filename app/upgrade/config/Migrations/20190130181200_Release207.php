...
class Release207 extends AbstractMigration
{
    ...
    public function up()
    {
        $this->bumpVersion('e2.0.7');
    }

    public function down()
    {
        $this->bumpVersion('e2.0.6');
    }
}
