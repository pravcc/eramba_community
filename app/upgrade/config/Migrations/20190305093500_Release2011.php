...
class Release2011 extends AbstractMigration
{
    protected function bumpVersion($value) {
        ...
        if (class_exists('App')) {
            ...
            if (Configure::read('Eramba.version') === 'e2.0.10') {
                ...
                $ret &= $ReportsModule->updateReports([
                    ...
                    'RiskItemDefaultReport',
                    'RiskSectionDefaultReport',
                    'ThirdPartyRiskSectionDefaultReport',
                    'ThirdPartyRiskItemDefaultReport',
                    'BusinessContinuityItemDefaultReport',
                    'BusinessContinuitySectionDefaultReport',
                    'SecurityServiceItemDefaultReport',
    ...
    public function up()
    {
        $this->bumpVersion('e2.0.11');
    }

    public function down()
    {
        $this->bumpVersion('e2.0.10');
    }
}
