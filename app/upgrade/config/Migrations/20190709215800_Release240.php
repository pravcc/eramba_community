...
class Release240 extends AbstractMigration
{
    protected function bumpVersion($value) {
        ...
        if (class_exists('App')) {
            ...
            if (Configure::read('Eramba.version') === 'c2.3.0') {
            }
        ...
        if (!$ret) {
            ...
            $log = "Error occured when processing database synchronization for 2.3.0.";
