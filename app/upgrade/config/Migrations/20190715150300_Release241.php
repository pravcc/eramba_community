...
class Release241 extends AbstractMigration
{
    protected function bumpVersion($value) {
        ...
        if (class_exists('App')) {
            ...
            if (Configure::read('Eramba.version') === 'c2.4.0') {
            }
        ...
        if (!$ret) {
            ...
            $log = "Error occured when processing database synchronization for 2.4.1.";
    ...
    public function up()
    {
        $this->bumpVersion('c2.4.1');
    }

    public function down()
    {
        $this->bumpVersion('c2.4.0');
    }
}
