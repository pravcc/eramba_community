...
class Release262 extends AbstractMigration
{
    protected function bumpVersion($value) {
        ...
        if (class_exists('App')) {
            ...
            if (Configure::read('Eramba.version') === 'e2.6.1') {
            }
        ...
        if (!$ret) {
            ...
            $log = "Error occured when processing database synchronization for 2.6.2.";
    ...
    public function up()
    {
        $this->bumpVersion('c2.6.2');
    }

    public function down()
    {
        $this->bumpVersion('c2.6.1');
    }
}
