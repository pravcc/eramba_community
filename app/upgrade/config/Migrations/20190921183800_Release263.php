...
class Release263 extends AbstractMigration
{
    protected function bumpVersion($value) {
        ...
        if (class_exists('App')) {
            ...
            if (Configure::read('Eramba.version') === 'e2.6.2') {
            }
        ...
        if (!$ret) {
            ...
            $log = "Error occured when processing database synchronization for 2.6.3.";
    ...
    public function up()
    {
        $this->bumpVersion('e2.6.3');
    }

    public function down()
    {
        $this->bumpVersion('e2.6.2');
    }
}
