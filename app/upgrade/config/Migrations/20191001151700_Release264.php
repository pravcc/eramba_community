...
class Release264 extends AbstractMigration
{
    protected function bumpVersion($value) {
        ...
        if (class_exists('App')) {
            ...
            if (Configure::read('Eramba.version') === 'c2.6.3') {
            }
        ...
        if (!$ret) {
            ...
            $log = "Error occured when processing database synchronization for 2.6.4.";
    ...
    public function up()
    {
        $this->bumpVersion('c2.6.4');
    }

    public function down()
    {
        $this->bumpVersion('c2.6.3');
    }
}
