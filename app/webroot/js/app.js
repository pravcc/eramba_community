...
var App = function() {
	...
	var handleResponsive = function() {
		...
		$('.navbar li.nav-toggle').off("click.Eramba").on("click.Eramba", function(e) {
	...
	var handleSidebarMenu = function() {
		...
		$('#sidebar-content ul > li > a').off('click.Eramba').on('click.Eramba', function (e) {
	...
	return {
		...
		blockUI: function (el, centerY) {
			var el = $(el);
			el.block({
				message: '<div class="spinner-icon"></div>',
