 ...
 * 
 * Load plugin model hack with base name.
 */
	public static function mapModelName($model) {
		$models = [
			'VendorAssessment' => 'VendorAssessments.VendorAssessment',
			'VendorAssessmentFeedback' => 'VendorAssessments.VendorAssessmentFeedback',
			'VendorAssessmentFinding' => 'VendorAssessments.VendorAssessmentFinding',
			'VendorAssessmentFindingsQuestion' => 'VendorAssessments.VendorAssessmentFindingsQuestion',
			'VendorAssessmentSystemLog' => 'VendorAssessments.VendorAssessmentSystemLog',
			'SystemLog' => 'SystemLogs.SystemLog',
			'AccountReview' => 'AccountReviews.AccountReview',
			'AccountReviewFeedback' => 'AccountReviews.AccountReviewFeedback',
			'AccountReviewFeedRow' => 'AccountReviews.AccountReviewFeedRow',
			'AccountReviewFeedPull' => 'AccountReviews.AccountReviewFeedPull',
			'AccountReviewPull' => 'AccountReviews.AccountReviewPull',
			'AccountReviewFeed' => 'AccountReviews.AccountReviewFeed',
			'AccountReviewFinding' => 'AccountReviews.AccountReviewFinding',
			'AccountReviewPullSystemLog' => 'AccountReviews.AccountReviewPullSystemLog',
			'LdapSynchronizationSystemLog' => 'LdapSync.LdapSynchronizationSystemLog',
			'LdapSynchronization' => 'LdapSync.LdapSynchronization',
			'Translation' => 'Translations.Translation',
			'ComplianceManagementMappingRelation' => 'Mapping.ComplianceManagementMappingRelation',
		];

		if (is_string($model) && !empty($models[$model])) {
			$model = $models[$model];
		}
 ...
 */
	public static function init($class, $strict = false) {
		...
		if (is_array($class)) {
			...
			foreach ($objects as $key => $params) {
				if (isset($objects[$key]['class'])) {
					$objects[$key]['class'] = self::mapModelName($objects[$key]['class']);
				}
			}
		} else {
